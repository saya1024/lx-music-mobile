...
import { handleDislikeMusic, handlePlay, handlePlayLater, handleRemove, handleShare, handleShowMusicSourceDetail, handleToggleLove, handleUpdateMusicInfo, handleUpdateMusicPosition } from './listAction'
  ...
  return (
    <View style={styles.container}>
      ...
      <ListMenu
        ...
        onToggleLove={info => { handleToggleLove(info.musicInfo) }}
